...
const searchResults = [
  { id: 1, name: "Office Hardware 2026", desc: "Laptops, monitors, and peripherals", category: "Hardware", creator: "Alice Smith", avatar: "https://i.pravatar.cc/150?u=1", match: "Matches 'hardware' in title, tags" },
  { id: 4, name: "Server Rack Equipment", desc: "Networking and server hardware", category: "Hardware", creator: "Bob Jones", avatar: "https://i.pravatar.cc/150?u=2", match: "Matches 'hardware' in tags" },
];
  ...
  return (
    <div className="flex flex-col gap-10 py-8">
      ...
      >
        ...
        <p className="text-default-500">Found {searchResults.length} inventories matching your current query.</p>
      </motion.div>
      ...
      <motion.section 
        ...
        className="w-full"
      >
        <Table aria-label="Search Results Table" className="shadow-lg" selectionMode="multiple" onRowAction={handleRowAction}>
          <TableHeader>
